        ...
        <div v-for="product in products" :key="product.id" class="group relative">
          ...
          <router-link :to="{ name: 'produto-detalhe', params: { id: product.id }}">
            ...
            <div class="text-center">
              ...
              <p class="text-lg font-bold text-gray-900 mt-2">R$ {{ product.price }}</p>
            </div>
          </router-link>
          ...
          <button 
            ...
            class="absolute top-4 right-4 bg-white p-3 rounded-full shadow-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300 hover:bg-[#9810FA] hover:text-white"
